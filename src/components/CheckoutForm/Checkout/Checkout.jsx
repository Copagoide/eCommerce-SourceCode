...
//This component is the last page the user sees after going through the products, the cart, the address form,
//the payment form and the review pages. It only displays whether the transaction was successful or not.
        ...
        <div className={classes.spinner}>
            <div>
                ...
                <div className={classes.circularProgress}>
                    <CircularProgress style={{ color: "#00a0a4" }}/>
                </div>
            </div>
        </div>
    );
            ...
            <main className={classes.layout}>
                <Paper className={classes.paper}>
                    ...
                    <Stepper activeStep={activeStep} className={classes.stepper}>
                        {steps.map((step) => (
                            <Step className={classes.root}  key={step}>
